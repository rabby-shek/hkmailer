          ...
          <div className="row" style={{ paddingBottom: "30px" }}>
            ...
            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 flex">
              <div style={{ width: "50%" }} className="flexNullCenter flexColumn">
                <ContactImgBox>
                  <img src={flyingplaneImg} style={{width:"50%"}} alt="office" className="radius6" />
                </ContactImgBox>
                <ContactImgBox>
                  <img src={ContactImg2} style={{ width: "50%" }} alt="office" className="radius6" />
                </ContactImgBox>
              </div>
              <div style={{ width: "50%" }}>
                <div style={{ marginTop: "100px" }}>
                  <img src={blossommsgImg} style={{width:"50%"}} alt="office" className="radius6" />
                </div>
              </div>
            </div>
          </div>
